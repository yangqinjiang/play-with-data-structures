...
// 在链表中不是一个常用的操作，练习用：）
func (this *LinkedList)Remove(index int) int{
	if index <0 || index >=this.size{
...
// 从链表中删除第一个元素, 返回删除的元素
func (this *LinkedList)RemoveFirst() int  {
	return this.Remove(0)
}
// 从链表中删除最后一个元素, 返回删除的元素
func (this *LinkedList)RemoveLast() int  {
	return this.Remove(this.size - 1)
}

//从链表中删除元素e
func (this *LinkedList)RemoveElement(e int)  {
	prev := this.dummyHead
	for(prev.Next != nil){
		if prev.Next.E == e{
			break//找到,中止for
