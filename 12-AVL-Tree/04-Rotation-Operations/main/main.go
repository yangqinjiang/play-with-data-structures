...
import (
	"fmt"
	. "github.com/yangqinjiang/play-with-data-structures/12-AVL-Tree/04-Rotation-Operations"
	"github.com/yangqinjiang/play-with-data-structures/12-AVL-Tree/04-Rotation-Operations/AVLTree"
...
func main() {
	...
	readFileAndTotalDifferentWordsCount("12-AVL-Tree/04-Rotation-Operations/pride-and-prejudice.txt",NewBSTMap())
	fmt.Println("use AVLTree")
	readFileAndTotalDifferentWordsCount2("12-AVL-Tree/04-Rotation-Operations/pride-and-prejudice.txt",AVLTree.NewAVLTree())
}
